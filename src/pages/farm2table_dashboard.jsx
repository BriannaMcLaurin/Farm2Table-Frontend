  ...
  return (
    <div className="farm-dashboard">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            ...
                            setSelectedCrops(selectedCrops.filter(name => name !== crop.name));
                          }
                        }}
                        value={crop.name}
                        data-price={crop.basePrice}
                      />
      ...
      <div className="action-section">
        <button id="f2t-apply-btn">Apply Selected Prices</button>
        <div id="f2t-tooltip" style={{ display: 'none' }}>
